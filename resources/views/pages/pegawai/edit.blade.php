        ...
        <form action="{{ route('pegawai.update',$data->id) }}" method="POST">
            ...
            @csrf            
                <div class="form-group">
                    ...
                    <input type="text" name="nik_pegawai" value="{{ $data->nik_pegawai }}" class="form-control" required>
                </div>
                <div class="form-group">
                    <label for="nama_pegawai" class="form-control-label">Nama Pegawai </label>
                    <input type="text" name="nama_pegawai" value="{{ $data->nama_pegawai }}" class="form-control" required>
                </div>
                <div class="form-group">
